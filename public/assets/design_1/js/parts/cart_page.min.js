...
(function () {
  ...
  var updatePayButtonState = function updatePayButtonState() {
    var $payButton = $('.js-cart-payment-btn');
    if (!$payButton.length) {
      return;
    }
    var hasSelectedGateway = $('input[name="gateway"]:checked').length > 0;
